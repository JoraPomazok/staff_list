(function($R)
{
    $R.add('plugin', 'background_color', {
        translations: {
            en: {
                "background_color": Translate('redactor_js/background_color'),
            }
        },
        init: function(app)
        {
        ...
        start: function()
        {
            ...
            var btnObj = {
                title: this.lang.get('background_color')
            };

            var $dropdown = this._buildDropdown();

            this.$button = this.toolbar.addButton('background_color', btnObj);
