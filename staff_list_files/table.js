(function($R)
{
    $R.add('plugin', 'table', {
        translations: {
            ...
            ru: {
                "table": Translate('redactor_js/table_title'),
                "insert-table": Translate('redactor_js/insert_table'),
                "insert-row-above": Translate('redactor_js/insert_row_above'),
                "insert-row-below": Translate('redactor_js/insert_row_below'),
                "insert-column-left": Translate('redactor_js/insert_column_left'),
                "insert-column-right": Translate('redactor_js/insert_column_right'),
                "delete-column": Translate('redactor_js/delete_column'),
                "delete-row": Translate('redactor_js/delete_row'),
                "delete-table": Translate('redactor_js/delete_table'),
                "rows": Translate('redactor_js/rows'),
                "columns": Translate('redactor_js/columns'),
                "add-head": Translate('redactor_js/add_head'),
                "delete-head": Translate('redactor_js/delete_head'),
        	}
        },
        init: function(app)
        {
