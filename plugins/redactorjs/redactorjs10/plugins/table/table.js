		...
		return {
			langs: {
				ru: {
                    ...
                    "insert-row-above": 'Добавить строку сверху',
                    "insert-row-below": 'Добавить строку снизу',
                    "insert-column-left": 'Добавить столбец слева',
                    "insert-column-right": 'Добавить столбец справа',
                    "delete-column": 'Удалить столбец',
                    "delete-row": 'Удалить строку',
                    "delete-table": 'Удалить таблицу',
                    "rows": 'Строки',
                    "columns": 'Столбцы',
                    "add-head": "Добавить заголовочный столбец",
                    "delete-head": "Удалить заголовочный столбец",
				}
			},
			init: function()
			{
