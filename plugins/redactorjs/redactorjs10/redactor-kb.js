	...
	Redactor.fn = $.Redactor.prototype = {
		...
		core: function()
		{
			return {
				...
				destroy: function()
				{
                    ...
                    this.core.editor().removeClass('js_omni_redactor_container');
		...
		focus: function()
		{
			return {
				...
				first: function()
				{
                    if(!this.core.editor().children().length);
					{
						return false;
					}
		...
		linkify: function()
		{
			return {
				...
				{
					var iframeStart = '<div class="' + this.opts.videoContainerClass + ' redactor-linkify-object"><iframe class="redactor-linkify-object" style="width: 500px; height: 281px;" src="';
