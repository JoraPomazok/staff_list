(function($R)
{
    $R.add('plugin', 'alignment', {
        translations: {
			...
			ru: {
				"align": Translate('redactor_js/align'),
				"align-left": Translate('redactor_js/align_left'),
				"align-center": Translate('redactor_js/align_center'),
				"align-right": Translate('redactor_js/align_right'),
				"align-justify": Translate('redactor_js/align_justify'),
    		}
        },
        init: function(app)
        {
